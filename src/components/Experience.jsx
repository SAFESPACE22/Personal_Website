...
const Experience = () => {
    return (
        <section id="experience" className="py-20 bg-obsidian">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/20 before:to-transparent">
                    {experiences.map((exp, index) => (
                        ...
                        >
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 bg-obsidian group-hover:border-white transition-colors shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-lg z-10">
                                <div className="w-3 h-3 bg-white rounded-full"></div>
                            </div>

                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 bg-obsidian/50 border border-white/10 rounded-xl shadow-sm hover:border-white/30 transition-all">
                                <div className="flex flex-col sm:flex-row justify-between mb-2 sm:mb-4">
                                    ...
                                    <span className="text-gray-400 text-sm font-mono">{exp.year}</span>
                                </div>
